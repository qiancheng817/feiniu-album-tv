...
public class FolderBrowseActivity extends FragmentActivity {
    ...
    private void initViews() {
        ...
        tvLoading.setTextColor(Color.parseColor("#8A8276"));
        ...
        tvFoldersTitle.setTextColor(Color.parseColor("#8A8276"));
        ...
        tvPhotosTitle.setTextColor(Color.parseColor("#8A8276"));
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View itemView) {
                ...
                itemView.setOnFocusChangeListener((v, hasFocus) -> {
                    if (hasFocus) {
                        v.setBackgroundResource(R.drawable.bg_card_focus);
