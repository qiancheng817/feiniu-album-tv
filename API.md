# 飞牛相册 TV API Documentation

This document describes the API endpoints and authentication mechanism used by 飞牛相册 TV to communicate with Feiniu NAS photo gallery.
